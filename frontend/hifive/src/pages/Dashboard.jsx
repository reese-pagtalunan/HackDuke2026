...
export default function Dashboard() {
    ...
    return (
        <div className="min-h-screen bg-brand-soft font-sans flex flex-col">
            ...
            <main className="flex-1 max-w-4xl w-full mx-auto p-4 md:py-8 pt-[96px] md:pt-[110px] pb-28 w-full relative">
            ...
            <nav className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[480px] bg-brand flex items-center justify-around py-3 pb-4 z-50 md:rounded-t-[28px] shadow-[0_-8px_30px_rgba(26,86,255,0.25)]">
                <div 
